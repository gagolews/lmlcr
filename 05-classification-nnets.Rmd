...
the Creative Commons Attribution-Share Alike 3.0 Unported license](figures/neuron){#fig:neuron}
...
![](figures/perceptron){#fig:perceptron}
...
![](figures/logistic_regression_binary){#fig:logistic_regression_binary}
