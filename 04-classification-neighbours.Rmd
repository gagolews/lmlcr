...
- *K-nearest neighbour scheme* -- this part
- *Decision trees* -- the next lecture
- *Logistic regression* -- the next lecture
...
curse of dimensionality. A dedicated unit on machine learning should
