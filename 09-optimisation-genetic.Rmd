...
In Lecture 7, we were dealing with
...
The class of general-purpose iterative algorithms we studied in Lecture 7
...
We need approximations. In the last lecture, we have
...
> This topic will covered extensively in a class on Mathematical
Modelling/Calculus. Here is just a very brief overview for the interested,
see also (Boyd, Vandenberghe, 2004).
...
and quadratic programming that involves convex functions, see a lecture in Mathematical Modelling.
...
that you will likely explore in a dedicated AI unit.
...
* Artificial bee/ant colony optimization
* Cuckoo Search
...
- D. Simon, *Evolutionary Optimization Algorithms: Biologically-Inspired
and Population-Based Approaches to Computer Intelligence*, John Wiley & Sons, 2013


- S.P. Boyd, L. Vandenberghe, *Convex Optimization*, Cambridge University Press, 2004.

    > Freely available at https://web.stanford.edu/~boyd/cvxbook/bv_cvxbook.pdf.
