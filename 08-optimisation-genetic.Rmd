...
![](figures/combination1){#fig:combination1 width=50%}
...
![](figures/combination2){#fig:combination2 width=50%}
...
![](figures/combination3){#fig:combination3 width=50%}
...
![](figures/convex_set){#fig:convex_set width=75%}
...
![](figures/convex_function){#fig:convex_function width=75%}
...
![](figures/convex_concave){#fig:convex_concave width=75%}
...
They are slow to run and don't guarantee anything, but yet they still might be useful -- better
