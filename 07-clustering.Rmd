...
or the Normalised Mutual Information Score (NMI),
see, e.g., [@comparing_paritions].
...
The `kmeans()` function itself implements 4 of them:
the Hartigan-Wong, Lloyd, Forgy and MacQueen algorithms.
