...
```{r,echo=-1,warning=FALSE,fig.height=5,echo=FALSE,cache=TRUE}
...
```{r,cache=TRUE,mnist_sgd,dependson='mnist_sgd1',echo=FALSE,fig.height=5,fig.width=10,out.width='100%'}
set.seed(123)
# random matrix of size 785x10 - initial guess
...
```{r,cache=TRUE,mnist_sgd2b,dependson='mnist_sgd2',echo=FALSE,fig.height=5,fig.width=10,out.width='100%'}
<<mnist_sgd>>
```
