...
fit_models <- function(ans) {
    ...
    plot(ans$x, ans$y, las=1) # scatter plot
...
par(mar=c(4, 4, 0.5, 0.5)) # reduce plot margins
f1 <- fit_models(ans1)
f2 <- fit_models(ans2)
f3 <- fit_models(ans3)
f4 <- fit_models(ans4)
...
par(mfrow=c(2, 2)) # four plots on 1 figure (2x2 grid)
par(mar=c(4, 4, 0.5, 0.5)) # reduce plot margins
plot(y_pred1, y_pred1-ans1$y, las=1)
plot(y_pred2, y_pred2-ans2$y, las=1)
plot(y_pred3, y_pred3-ans3$y, las=1)
plot(y_pred4, y_pred4-ans4$y, las=1)
```
